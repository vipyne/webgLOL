;(function(w, d, u) {
  ...
  //   // timing
  //   this.startTime = this.startTime ? this.startTime : new Date().getTime() / 5000;
  //   var time = new Date().getTime() / 5000 - this.startTime;
  ...
  // }
  function webglol() {
    var reader = new FileReader('./vertexShader.txt');
    var derp = './vertexShader.txt'
    var blob = new Blob([reader], {type: 'plain/text'});
    console.log('asdf', blob);
  }
webglol();
